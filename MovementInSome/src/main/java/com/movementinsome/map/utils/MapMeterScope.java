...
import com.movementinsome.app.pub.asynctask.RegionAnalyzeTask6;
import com.movementinsome.app.pub.asynctask.SelectAnalyzeTask;
import com.movementinsome.map.view.MyMapView;

import java.util.ArrayList;
import java.util.List;

public class MapMeterScope {
	...
	public MapMeterScope(ShowPatrolDataExpActivity showPatrolDataExpActivity, MyMapView map,Context context, String tableNum) {
			...
			if(isShowCallout){
				...
				tv.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View arg0) {
						...
						RegionAnalyzeTask6 regionAnalyzeTask = new RegionAnalyzeTask6(showPatrolDataExpActivity,context,PolygonStr,tableNum,"普通给水管线");
			...
			if(isShowCallout){
				...
				tv.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View arg0) {
						// TODO Auto-generated method stub
						String PolygonStr = "POINT  ("+x2+" "+y2+")";
						RegionAnalyzeTask6 regionAnalyzeTask = new RegionAnalyzeTask6(showPatrolDataExpActivity,context,PolygonStr,tableNum,"阀门");
						regionAnalyzeTask.execute("");
					}
				});
				map.getCallout().hide();
			...
			if(isShowCallout){
				...
				tv.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View arg0) {
						// TODO Auto-generated method stub
						String PolygonStr = "POINT  ("+x2+" "+y2+")";
						SelectAnalyzeTask selectAnalyzeTask = new SelectAnalyzeTask(showPatrolDataExpActivity,context,PolygonStr,tableNum);
						selectAnalyzeTask.execute("");
					}
				});
				map.getCallout().hide();
				map.getCallout().show(point,tv);
