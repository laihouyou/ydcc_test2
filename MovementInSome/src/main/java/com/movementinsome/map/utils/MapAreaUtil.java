...
public class MapAreaUtil {
	...
	private MapBizViewer mapBizViewer;

	public MapAreaUtil(MyMapView map,Context context, MapBizViewer mapBizViewer) {
		this.context=context;
		this.mapBizViewer = mapBizViewer;
		this.map = map;
			...
			if(isShowCallout){
				...
				tv.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View v) {
						// TODO Auto-generated method stub
						AppContext.getInstance().setmMapArea(getAreaString());
