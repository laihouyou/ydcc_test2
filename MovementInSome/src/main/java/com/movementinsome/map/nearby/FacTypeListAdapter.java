...
public class FacTypeListAdapter extends BaseAdapter{
	...
	public FacTypeListAdapter(List<List<FacTypeObj>>fac_type_data,Context context,MyMapView mapView,GraphicsLayer grapLayer,NearByTools nearByTools){
		...
		if(d!=null){
			...
			for(int i=0;i<d.size();++i){
				if(i==0){// 默认第一个是总类型
					...
					b.setOnClickListener(new FacOnClickListener(context,mapView,grapLayer,fac_type_data.get(position).get(i),nearByTools));
