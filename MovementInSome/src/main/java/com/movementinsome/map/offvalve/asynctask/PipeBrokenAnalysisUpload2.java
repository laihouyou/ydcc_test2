...
public class PipeBrokenAnalysisUpload2 extends AsyncTask<List<String>, Void, JSONObject>{
	 ...
	 * @param output
	 */
	public PipeBrokenAnalysisUpload2(PipeBroAnalysisTools2 pipeBroAnalysisTools2) {
...
/*		try{
		...
		if(result==null)
			return null;
		try {
			pipeBroAnalysisTools2.setPipeBreakenData(result);
	...
	protected void onPostExecute(JSONObject result) {
		...
		if(result!= null){
			...
			//	pipeBroAnalysisTools.analysisGraphicPoint(Float.parseFloat(x), Float.parseFloat(y), "1");
				PipeBroAnalysis2 analysisTask = new PipeBroAnalysis2(pipeBroAnalysisTools2, true,point,null);
