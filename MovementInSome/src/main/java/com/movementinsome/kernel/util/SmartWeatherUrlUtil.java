...
public class SmartWeatherUrlUtil {
	...
	private static final String appid = "babfdde29ebe6ca3";
	private static final String private_key = "f7eb9d_SmartWeatherAPI_c774fc7";
	...
	/**
	 * 获取天气信息
	 * @param areaid 101280101 广州，101280601 深圳
	 * @param type 预警:alarm 实况:observe 指数:index 常规预报(24小时):forecast1d
	 * @return
	 */
