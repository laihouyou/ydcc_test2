...
public class ZsWorkTaskWebActivity extends FullActivity implements OnClickListener  {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		url = "http://59.33.37.170:9004/gisApp/solution/mobile/workTaskOrder.jsp?userId=";
