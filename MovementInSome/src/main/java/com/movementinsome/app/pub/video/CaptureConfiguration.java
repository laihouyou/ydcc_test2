...
public class CaptureConfiguration implements Parcelable {
    ...
    private int mVideoWidth       = PredefinedCaptureConfigurations.WIDTH_360P;
    private int mVideoHeight      = PredefinedCaptureConfigurations.HEIGHT_360P;
    private int mBitrate          = PredefinedCaptureConfigurations.BITRATE_HQ_360P;
